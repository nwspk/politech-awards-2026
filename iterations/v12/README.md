...
- `iterations/project-mirror-v2/committee-aggregation/committee-ranking-v12.csv`
...
ODE is broadly legible across constitutions because it serves non-technical users — nonprofits, data journalists, activists, public servants — which maps onto multiple evaluation frameworks at once. LiquidFeedback's mean lead comes from a handful of passionate advocates rather than broad committee consensus.
