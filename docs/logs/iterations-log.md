...
| v10 | 2026-03-30 | @sugaroverflow | open | For each project, compute the median of its rank position across all 17 members' v11 scores (14×v2 + 3×v3). Projects are ordered by median rank ascending — lower is better. Ties broken by mean rank. | [v10](https://github.com/nwspk/politech-awards-2026/pull/104) | [entry](#v10-on-balance-mirror-agents-committee-average-median-rank) |

## Full iteration records

### v10 On Balance — Mirror Agents Committee Average, median rank

- **PR**: [v10](https://github.com/nwspk/politech-awards-2026/pull/104)
- **Status**: open
- **Author**: @sugaroverflow
- **Date**: 2026-03-30
- **Top project**: [okfn.org](https://okfn.org/en/projects/open-data-editor) (score: 61.96)
