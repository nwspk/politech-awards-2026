...
| v10 | 2026-03-30 | @sugaroverflow | open | Projects ranked by standard deviation of scores across all 17 members (v11 score set: 14×v2 + 3×v3). High stdev = the committee disagrees sharply. Only projects with coverage ≥ 15/17 included. | [v10](https://github.com/nwspk/politech-awards-2026/pull/105) | [entry](#v10-in-dispute-projects-that-split-the-committee) |

## Full iteration records

### v10 In Dispute — Projects that split the committee

- **PR**: [v10](https://github.com/nwspk/politech-awards-2026/pull/105)
- **Status**: open
